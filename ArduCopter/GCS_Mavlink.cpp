...
#endif
        MAV_AUTOPILOT_ARDUPILOTMEGA,//03
        base_mode,//0x51
        custom_mode,
        system_status);
}
...
{
    const Vector3f &gyro = ahrs.mti_gyro();//edit by huhui 
...
void NOINLINE Copter::send_location(mavlink_channel_t chan)
{
    ...
    mavlink_msg_global_position_int_send(
        ...
        ahrs.mti_yaw_sensor);               // compass heading in 1/100 degree  //edit by huhui 
}
...
void GCS_MAVLINK::handleMessage(mavlink_message_t* msg)
{
    ...
    case MAVLINK_MSG_ID_COMMAND_LONG:       // MAV ID: 76
    {
        ...
        case MAV_CMD_PREFLIGHT_CALIBRATION:
            ...
            } else if (false) {//edit by huhui      is_equal(packet.param5,1.0f)
            ...
            } else if (false) {//edit by huhui       is_equal(packet.param5,2.0f)
                // accel trim
                float trim_roll, trim_pitch;
