...
public:
    ...
    RC_Channel      heli_servo_rsc,heli_servo_tilt;                                             // servo for rotor speed control output
#endif
    ...
    Parameters() :
        ...
        heli_servo_3        (CH_3),
        heli_servo_4        (CH_4),
		heli_servo_5        (CH_5),//edit by huhui 
		heli_servo_6        (CH_6),
        heli_servo_rsc      (CH_10),
		heli_servo_tilt     (CH_11),
#endif
#if FRAME_CONFIG ==     SINGLE_FRAME
        single_servo_1        (CH_1),
        single_servo_2        (CH_2),
