...
Copter::Copter(void) :
    ...
    motors(g.rc_7, g.heli_servo_rsc,g.heli_servo_tilt, g.heli_servo_1, g.heli_servo_2, g.heli_servo_3, g.heli_servo_4,g.heli_servo_5,g.heli_servo_6,MAIN_LOOP_RATE),
	...
	//edit by huhui
	mtig_data_success(false),
	r_state(0),
	sum(0),
	read_number(0),
	MTI_Length(7),
	valid_ekf_origin(false),
