...
#define AC_ATTITUDE_CONTROL_DEGX100 5729.57795131f                   // constant to convert from radians to centi-degrees
...
#define AC_ATTITUDE_2000HZ_DT                            0.0005f
...
public:
    ...
    void set_yaw_target_to_current_heading() { _angle_ef_target.z = _ahrs.mti_yaw_sensor; }
