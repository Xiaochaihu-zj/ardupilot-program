...
AC_PosControl::AC_PosControl(const AP_AHRS& ahrs, const AP_InertialNav& inav,
    ...
    _dt(POSCONTROL_DT_400HZ),//400
    _dt_xy(POSCONTROL_DT_50HZ),//50
...
void AC_PosControl::set_pos_target(const Vector3f& position)
{
    ...
    //_roll_target = constrain_int32(_ahrs.mti_roll_sensor,-_attitude_control.lean_angle_max(),_attitude_control.lean_angle_max());
    //_pitch_target = constrain_int32(_ahrs.mti_pitch_sensor,-_attitude_control.lean_angle_max(),_attitude_control.lean_angle_max());
}
...
void AC_PosControl::init_xy_controller(bool reset_I)
{
    ...
    _roll_target = _ahrs.mti_roll_sensor;
    _pitch_target = _ahrs.mti_pitch_sensor;
