...
#define INS_MAX_INSTANCES 1//edit by huhui 
...
public:
    ...
    ///
    const Vector3f     &get_gyro(uint8_t i) const { return mti_gyro; }
    ...
    ///
    const Vector3f     &get_accel(uint8_t i) const { return mti_accel; }
	...
	//edit by huhui 
    bool get_gyro_health(uint8_t instance) const { return (instance<_gyro_count) ?  true: false; }//_gyro_healthy[instance]
    ...
    bool get_accel_health(uint8_t instance) const { return (instance<_accel_count) ? true : false; }//_accel_healthy[instance]
