...
public:
    ...
    virtual const Vector3f &get_accel_ef(uint8_t i) const { return _ins.mti_accel; }
    virtual const Vector3f &get_accel_ef(void) const { return get_accel_ef(_ins.get_primary_accel()); }

    // blended accelerometer values in the earth frame in m/s/s
    virtual const Vector3f &get_accel_ef_blended(void) const { return _ins.mti_accel; }
    ...
    float cos_roll() const  { return _mti_cos_roll; }
    float cos_pitch() const { return _mti_cos_pitch; }
    float cos_yaw() const   { return _mti_cos_yaw; }
    float sin_roll() const  { return _mti_sin_roll; }
    float sin_pitch() const { return _mti_sin_pitch; }
    float sin_yaw() const   { return _mti_sin_yaw; }
	...
	//edit by huhui 
	float  mti_roll;//radians
	float  mti_pitch;
	float  mti_yaw;
	
	
	Vector3f mti_accel_ef;
	
	
	int32_t mti_roll_sensor;//deg*100
	int32_t mti_pitch_sensor;
	int32_t mti_yaw_sensor;
	
	float mti_cos_roll() const  { return _mti_cos_roll; }
	float mti_cos_pitch() const  { return _mti_cos_pitch; }
	float mti_cos_yaw()   const {return _mti_cos_yaw;}
	
	float mti_sin_roll() const  { return _mti_sin_roll; }
	float mti_sin_pitch() const  { return _mti_sin_pitch; }
	float mti_sin_yaw()   const {return _mti_sin_yaw;}
	
	void set_mti_dcm(void);
	void update_mti_atti_values(void);
    Vector3f mti_gyro(void) const {return _ins.mti_gyro;}
	Vector3f mti_accel(void) const {return _ins.mti_accel;}
...
protected:
	...
	//edit by huhui 
	float _mti_cos_roll,_mti_cos_pitch,_mti_cos_yaw;
	float _mti_sin_roll,_mti_sin_pitch,_mti_sin_yaw;
