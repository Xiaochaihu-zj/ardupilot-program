...
const AP_Param::GroupInfo AP_MotorsMulticopter::var_info[] PROGMEM = {
    ...
    // @User: Standard
    AP_GROUPINFO("MOTOR_SPIN_ARMED", 5, AP_MotorsMulticopter, _spin_when_armed, AP_MOTORS_SPIN_WHEN_ARMED),
...
void AP_MotorsMulticopter::set_throttle_range(uint16_t min_throttle, int16_t radio_min, int16_t radio_max)
{
    ...
    _rpy_pwm_scalar = (_throttle_radio_max - (_throttle_radio_min + _min_throttle)) / 9000.0f;//1900  1100 130 
