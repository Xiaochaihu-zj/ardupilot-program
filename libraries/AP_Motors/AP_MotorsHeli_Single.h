...
#define AP_MOTORS_HELI_SINGLE_RSC                              CH_10//edit by huhui 
#define AP_MOTORS_HELI_SINGLE_AUX                              CH_7
//edit by huhui 
#define AP_MOTORS_HELI_SINGLE_TILT                             CH_11
...
//edit by huhui
#define DEFAULT_COL_DIFF_ANGLE           60
#define DEFAULT_LONG_DIFF_ANGLE          70
#define DEFAULT_LONG_SYN_ANGLE           30
...
public:
    ...
    AP_MotorsHeli_Single(RC_Channel&    servo_aux,
						 ...
						 RC_Channel&    servo_tilt,
                         RC_Channel&    servo_1,
                         RC_Channel&    servo_2,
                         RC_Channel&    servo_3,
                         RC_Channel&    servo_4,//edit by huhui
						 RC_Channel&    servo_5,
						 RC_Channel&    servo_6,
                         uint16_t       loop_rate,
		...
		_swash_servo_4(servo_4),//edit by huhui 
		...
		_tilt_servo(servo_tilt,AP_MOTORS_HELI_SINGLE_TILT,loop_rate)
    {
	...
	AP_Int16        my_parameter;//edit by huhui 
	
	//edit by huhui
	void set_tilt_servo_pos(int16_t tilt_servo_pos){_tilt_servo.set_tilt_pos(tilt_servo_pos);}
...
protected:
	...
	RC_Channel&     _swash_servo_4;   //edit by huhui 
	RC_Channel&     _swash_servo_5;   
	RC_Channel&     _swash_servo_6;   
    //RC_Channel&     _yaw_servo;                 // tail servo

    AP_MotorsHeli_RSC   _main_rotor;            // main rotor
    AP_MotorsHeli_RSC   _tail_rotor;            // tail rotor
	//edit by huhui 
	AP_MotorsHeli_RSC   _tilt_servo;

	float _rpy_scalar; //edit by huhui
	...
	int16_t          _judge_col_diff;
	int16_t          _judge_long_diff;
	int16_t          _judge_long_syn;
