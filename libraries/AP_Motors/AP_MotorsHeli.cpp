...
const AP_Param::GroupInfo AP_MotorsHeli::var_info[] PROGMEM = {
    ...
    // @Increment: 1
    // @User: Standard
    AP_GROUPINFO("COL_MIN", 3, AP_MotorsHeli, _collective_min, AP_MOTORS_HELI_COLLECTIVE_MIN),//1250
    ...
    // @Increment: 1
    // @User: Standard
    AP_GROUPINFO("COL_MAX", 4, AP_MotorsHeli, _collective_max, AP_MOTORS_HELI_COLLECTIVE_MAX),//1750
    ...
    // @Increment: 1
    // @User: Standard
    AP_GROUPINFO("COL_MID", 5, AP_MotorsHeli, _collective_mid, AP_MOTORS_HELI_COLLECTIVE_MID),//1500
    ...
    // @Increment: 100
    // @User: Advanced
    AP_GROUPINFO("CYC_MAX", 16, AP_MotorsHeli, _cyclic_max, AP_MOTORS_HELI_SWASH_CYCLIC_MAX),//2500
	...
	//edit by huhui
	// @Param: TILT_HIGH
    // @DisplayName: tilt_servo Servo high Power Position
    // @Description: tilt_servo output angle at vertical.
    // @Range: 1100 1900
    // @Increment: 10
    // @User: Standard
    AP_GROUPINFO("TILT_HIGH", 18, AP_MotorsHeli, _tilt_high_pos, AP_MOTORS_HELI_TILT_HIGH_DEFAULT),
	
	
	// @Param: TILT_LOW
    // @DisplayName: tilt_servo Servo low Power Position
    // @Description: tilt_servo output angle at zero.
    // @Range: 1100 1900
    // @Increment: 10
    // @User: Standard
    AP_GROUPINFO("TILT_LOW", 19, AP_MotorsHeli, _tilt_low_pos, AP_MOTORS_HELI_TILT_LOW_DEFAULT),
